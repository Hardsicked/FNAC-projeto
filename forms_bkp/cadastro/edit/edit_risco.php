			...
			<table class="table table-light table-stripped table-sm">
				...
				<?php while ($assoc_risco = mysqli_fetch_assoc($qry_risco)){
					...
					<tr>
						...
						<td class="text-center"><textarea id="" class="" name="fontes" cols="30" rows="10">'.$assoc_risco["fonte"].'</textarea></td>
					</tr>
					<tr>
						<td class="text-center">Medidas de Controle Existente</td>
						<td class="text-center"><textarea id="" class="" name="controle" cols="30" rows="10">'.$assoc_risco["controle"].'</textarea></td>
					</tr>
					<tr>
