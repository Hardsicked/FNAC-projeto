...
<form id="" class="" action="/fnac/forms/cadastro/post/form_editContrato.php" method="POST">
		...
		<?php
			...
			<tr>
				<td colspan="3"><h5>Validade do Programa Legal: </h5><br>
					...
					<h5>Data Final: </h5><input type="date" id="" class="" name="vDataFinal" value="'.date('Y-m-d',strtotime($assoc["exec_data_final"])).'" required>
				</td>
			</tr>
			<tr>
