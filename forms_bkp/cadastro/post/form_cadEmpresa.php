<?php  
	...
	if($_POST["nmEmpresa"] || $_POST["endereco"] || $_POST["razaoSocial"] || $_POST["nmFantasia"] || $_POST["cnpj"]){
		$sql = "INSERT INTO tbempresa(arquivo,nomeEmpresa,endereco,razaoSocial,nomeFantasia,cnpj) values('".$fileloc."','".$nmEmpresa."','".$endereco."','".$razaoSocial."','".$nmFantasia."','".$cnpj."')";
		if(mysqli_query($link,$sql)){
			echo "<script>alert('Empresa Cadastrada com Sucesso.'); window.location='../../../syst.php';</script>";
		}else{
