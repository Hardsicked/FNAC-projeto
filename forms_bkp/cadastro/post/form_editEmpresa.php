<?php 
	...
	$cnpj = $_POST["cnpj"];
	$pasta = '../../../img_empresas/';
		if($_POST["nmEmpresa"] || $_POST["endereco"] || $_POST["razaoSocial"] || $_POST["nmFantasia"] || $_POST["cnpj"] && empty($_FILES)){
			$sql = "UPDATE tbempresa SET nomeEmpresa='".$nmEmpresa."', endereco='".$endereco."', razaoSocial='".$razaoSocial."', nomeFantasia='".$nmFantasia."', cnpj='".$cnpj."' WHERE cdEmpresa='".$cdEmpresa."'";
			if(mysqli_query($link,$sql)){
				echo "<script>alert('Empresa Modificada com Sucesso.'); window.location='../../../syst.php';</script>";
			}else{
			...
			$sql = "UPDATE tbempresa SET arquivo ='".$fileloc."', nomeEmpresa='".$nmEmpresa."', endereco='".$endereco."', razaoSocial='".$razaoSocial."', nomeFantasia='".$nmFantasia."', cnpj='".$cnpj."' WHERE cdEmpresa='".$cdEmpresa."'";
			if(mysqli_query($link,$sql)){
				echo "<script>alert('Empresa Modificada com Sucesso.'); window.location='../../../syst.php';</script>";
			}else{
				echo "Erro ao Cadastrar Empresa".mysqli_error($link);
