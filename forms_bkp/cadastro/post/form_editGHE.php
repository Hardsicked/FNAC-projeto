<?php
	...
	$sql = "UPDATE tbghe SET cdContrato='".$cdContrato."', codGHE='".$codGHE."', nomeGHE='".$nomeGHE."', numEmpregados='".$numEmpregados."', jornadaTrab='".$jornadaTrab."', descTrab='".$descTrab."', tipoCont='".$tipoCont."' WHERE cdGHE=".$cdGHE;
