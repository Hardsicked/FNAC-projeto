...
<form id="" class="" action="/fnac/forms/cadastro/post/form_cadContrato2.php" method="POST">
		...
		<tbody>
			...
			<tr>
				<td colspan="3"><h5>Serviços:</h5><br>
					...
					<input type="checkbox" id="" class="" name="PPRA_quant" value="1">PPRA Quantitativo(Com Ficha de Campo)<br>
					<input type="checkbox" id="" class="" name="PPRA_direta" value="1">PPRA Inserção Direta(Sem Ficha de Campo)<br>
					<input type="checkbox" id="" class="" name="PPRA_qualit" value="1">PPRA Qualitativo(Sem Resultados Númericos)<br>
