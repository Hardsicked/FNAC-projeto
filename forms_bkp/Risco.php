											...
											while($row3 = mysqli_fetch_assoc($res3)){
												...
												while($row4 = mysqli_fetch_assoc($res4)){
													...
													while($row5 = mysqli_fetch_assoc($qry5)){
														$sql6 = "SELECT * FROM tbghe WHERE cdGHE = ".$row1["cdGHE"];
														$qry6 = mysqli_query($link,$sql6);
														while($row6 = mysqli_fetch_assoc($qry6)){
															...
															echo '
																<tr style="background-color: ">
																	...
																	<td class="text-center">' . $row6['nomeGHE'] . '</td>
																	...
																	<td class="text-center"><img src="img/icons/delete.png" width="24px" height="24px" data-fancybox data-type="ajax" data-src="forms/cadastro/post/forms_riscoGHE.php?cd=' . $row["cdRisco"] . '" href="javascript:;" class="icone2"/></td>
																</tr>
															';
														}
													}
