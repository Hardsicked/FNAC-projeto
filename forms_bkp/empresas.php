		...
		<div class="row"">
			<div id="tabela" class="col-12">
									...
									while($row = mysqli_fetch_assoc($res1)){
										echo '
											<tr style="background-color: ">
												...
												<td class="text-center"><img data-fancybox data-type="ajax" data-src="forms/cadastro/edit/edit_empresa.php?cd=' . $row["cdEmpresa"] . '" href="javascript:;" class="icone2" style="cursor: pointer" width="24px" height="24px" src="img/icons/edit.png"/></td>
												<td class="text-center"><img data-fancybox data-type="ajax" data-src="forms/cadastro/post/form_delEmpresa.php?c=' . $row["cdEmpresa"] . '" href="javascript:; class="icone2" style="cursor: pointer" width="24px" height="24px" src="img/icons/delete.png"/></td>
											</tr>
										';
									}
								}else{
					...
					<table class="table table-striped table-responsive-xl table-sm table-bordered"  style="margin-top: 40px">
						<thead class="thead-light">
							<tr>
								<th colspan="8">Outras Empresas</th>
							</tr>
							<tr>
								<th class="text-center">Cadastro</th>
								<th class="text-center">Logo</th>
