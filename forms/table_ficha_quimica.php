	...
	<body>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-6"></div>
				<div class="col-3">
					<div class="novobotao text-center novoruido" resultado="forms/cadastro/add_ficha_quimico.php?c=<?php echo $contratoid; ?>" style="margin-top: 8px; background-color: #94f441; cursor: pointer; color: white; border-radius: 2px;"><b>Nova Ficha Quimica</b></div>
				</div>
			</div>
			<div class="row">
