	...
	<script>
		$(document).ready(function(){
			...
			$("#btncadastrar").click(function(){
				...
				$(".progress").show(0);
				$.ajax({
					url: "forms/cadastro/post/form_cadResultadoquimico.php",
					type: 'POST',
					...
					<form method="POST" id="cadastrar" enctype="multipart/form-data">
						<div class="row">
							<div class="col-3">
								...
								<div class="form-group">
									<label for="EPC" class="col-form-label">EPC</label>
							...
							<div class="col-3">	
								...
								<div class="form-group" id="just2">
									...
									<textarea name="justificativa" id="just" required style="height: 80px; width: 95%;" value="" required></textarea>
								</div>
								<div class="form-group">
