...
<body>
	<form id="" class="" action="/fnac/forms/cadastro/post/form_cadFichaRuidoInfo.php" method="POST">
		<input type="text" value="<?php echo $ficha; ?>" name="ficha" hidden>
		<table class="table table-sm table-light">
			...
			<tbody>
				<tr>
					...
					<td><input type="text" name="descativ" size="100"></td>
				</tr>
				<tr>
					<td>Local</td>
					<td><input type="text" name="local" size="100"></td>
				</tr>
				<tr>
					<td>Horário</td>
				...
				<tr>
					...
					<td><input type="text" name="fonte" size="100"></td>
				</tr>
				<tr>
