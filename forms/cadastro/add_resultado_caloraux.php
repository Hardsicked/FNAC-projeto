...
<body>
	<?php 
	if($type == 0){
		echo'<form id="" class="" action="/fnac/forms/cadastro/add_resultado_calor.php" method="POST">';
	}elseif($type == 1){
		echo'<form id="" class="" action="/fnac/forms/cadastro/add_resultado_calorinfo.php" method="POST">';
	}
	?>
