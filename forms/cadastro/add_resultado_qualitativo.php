...
<body>
	<form id="" class="" action="/fnac/forms/cadastro/post/form_cadResultadoqualitativo.php" method="POST">
		<table class="table table-sm table-light">
			...
			<tbody>
							...
							echo '<td>Agente Quimico <img height="20px" width="20px" style="margin-top: -4px;" src="../../img/icons/alert.png"/></td>
									<td>
										<select id="" class="" name="cdRisco" disabled>
											<option id="" class="" >Nenhum Risco Qualitativo cadastrado</option>
								';
						}
					?>
						</select>					
				...
				<tr>
					<td>Resultado</td>
					<td><textarea rows="10" cols="100" name="texto" required></textarea></td>
				</tr>
				<tr>
					<td>EPI Adequada?</td>
					<td><select name="epia" required>
				...
				<tr>
					<td>Observação</td>
					<td><textarea rows="10" cols="100" name="obs" required></textarea></td>
				</tr>
				<tr>
					<td>GFIP</td>
