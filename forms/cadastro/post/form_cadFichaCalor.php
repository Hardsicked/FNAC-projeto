<?php  
	...
	mkdir("../../..//ficha/".md5($folderuniquename)."/", 0700);
		...
		$sql = "INSERT INTO tbficha_quali(dataAval,medDeControle,descMed,colaborador,colaborador_ma,supervisor,supervisor_ma,avaliador,avaliador_ma,pasta,pdfname) VALUES('".$dataaval."','".$meddectrl."','".$descmed."','".$colab."','".$colabm."','".$superv."','".$supervm."','".$aval."','".$avalm."','".$folder."','".$pdf."')";
		if(mysqli_query($link, $sql)){
			$idruido = $link->insert_id;
			$sql1 = "INSERT INTO tbficha_ghe(cdGHE,cdFicha,tipo,DR) VALUES('".$ghe."','".$idruido."',4,'".$dr."')";
