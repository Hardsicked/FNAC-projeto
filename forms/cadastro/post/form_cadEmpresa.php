<?php  
	...
	$cnpj = $_POST["cnpj"];
	$cep = $_POST["cep"];
	$razaolocal = $_POST["nmlocal"];
	$undlocal= $_POST["undlocal"];
	$endlocal = $_POST["endlocal"];
	$cpnjlocal = $_POST["cnpjlocal"];
	$razaoresp = $_POST["nmresp"];
	$undresp= $_POST["undresp"];
	$endresp = $_POST["endresp"];
	$cpnjresp = $_POST["cnpjresp"];
	$pasta = '../../../img_empresas/';
	print_r($_FILES);
	...
	if($_POST["nmEmpresa"] || $_POST["endereco"] || $_POST["razaoSocial"] || $_POST["nmFantasia"] || $_POST["cnpj"]){
		...
		if(mysqli_query($link,$sql)){
			$cdEmpresa = $link->insert_id;
			$sql2 = "INSERT INTO tblocal(cdEmpresa,razaoSocial,unidade,endereco,cnpj) values('".$cdEmpresa."','".$razaolocal."','".$undlocal."','".$endlocal."','".$cnpjlocal."')";
			if(mysqli_query($link,$sql2)){
				$sql3 = "INSERT INTO tbempresa_resp(cdEmpresa,razaoSocial,unidade,endereco,cnpj) values('".$cdEmpresa."','".$razaoresp."','".$undresp."','".$endresp."','".$cnpjresp."')";
