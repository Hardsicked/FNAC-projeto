<?php  
	...
	$sql = "INSERT INTO tbperfis(cdEmpresa,responsavel,cargoeng,tecnico,cargotec,endereco,logomarca,logorodape,observacao) values('".$cdEmpresa."','".$responsavel."','".$cargoeng."','".$tecnico."','".$cargotec."','".$endereco."','".$fileloc."','".$logorodape."','".$observacoes."')";
	if(mysqli_query($link,$sql)){
		echo "<script>alert('Pefil de Empresa Cadastrado com Sucesso.'); window.location='../../../syst.php';</script>";
	}else{
