...
<script>
	...
	<body>
		<div class="container">
			<div class="col-12">
				<form id="" class="" action="/fnac/forms/cadastro/post/form_editAgente.php?c=<?php echo $cdagente ?>" method="POST">
					<table class="table-sm table table-responsive-xl table-light">
						...
						<tbody>
								...
								<td>';
									...
									if($qry2->num_rows > 0){
											while ($row2 = mysqli_fetch_assoc($qry2)){
												if($row2["cdSubGrupo"] == $rowag["cdsubGrupo"]){
													echo '<option id="" class="" value="'.$row2["cdSubGrupo"].'" selected>'.$row2["nome"].'</option>';
												}else{
							...
							<tr>
								...
								<td>';
								if($rowag["unidadeMedida"] == 1){
									echo'<select id="" class="" name="unidadeMedida" required>
										<option value="0" >Nenhuma
										<option id="" class="" value="1" selected>ppm
										<option id="" class="" value="2">mg/m³
										<option id="" class="" value="3">db(a)
										<option id="" class="" value="4">Cº
										<option id="" class="" value="5">ms/2
										<option id="" class="" value="6">mg
									</select>';
								}elseif($rowag["unidadeMedida"] == 2){
									echo'<select id="" class="" name="unidadeMedida" required>
										<option value="0">Nenhuma
										<option id="" class="" value="1">ppm
										<option id="" class="" value="2" selected>mg/m³
										<option id="" class="" value="3">db(a)
										<option id="" class="" value="4">Cº
										<option id="" class="" value="5">ms/2
										<option id="" class="" value="6">mg
									</select>';
								}elseif($rowag["unidadeMedida"] == 3){
									echo'<select id="" class="" name="unidadeMedida" required>
										<option value="0">Nenhuma
										<option id="" class="" value="1">ppm
										<option id="" class="" value="2">mg/m³
										<option id="" class="" value="3" selected>db(a)
										<option id="" class="" value="4">Cº
										<option id="" class="" value="5">ms/2
										<option id="" class="" value="6">mg
									</select>';
								}elseif($rowag["unidadeMedida"] == 4){
									echo'<select id="" class="" name="unidadeMedida" required>
										<option value="0">Nenhuma
										<option id="" class="" value="1">ppm
										<option id="" class="" value="2">mg/m³
										<option id="" class="" value="3">db(a)
										<option id="" class="" value="4" selected>Cº
										<option id="" class="" value="5">ms/2
										<option id="" class="" value="6">mg
									</select>';
								}elseif($rowag["unidadeMedida"] == 5){
									echo'<select id="" class="" name="unidadeMedida" required>
										<option value="0">Nenhuma
										<option id="" class="" value="1">ppm
										<option id="" class="" value="2">mg/m³
										<option id="" class="" value="3">db(a)
										<option id="" class="" value="4">Cº
										<option id="" class="" value="5" selected>ms/2
										<option id="" class="" value="6">mg
									</select>';
								}elseif($rowag["unidadeMedida"] == 6){
									echo'<select id="" class="" name="unidadeMedida" required>
										<option value="0">Nenhuma
										<option id="" class="" value="1">ppm
										<option id="" class="" value="2">mg/m³
										...
										<option id="" class="" value="4">Cº
										<option id="" class="" value="5">ms/2
										<option id="" class="" value="6" selected>mg
									</select>';
								}else{
									echo'<select id="" class="" name="unidadeMedida" required>
										<option value="0" selected>Nenhuma
										<option id="" class="" value="1">ppm
										<option id="" class="" value="2">mg/m³
										<option id="" class="" value="3">db(a)
										<option id="" class="" value="4">Cº
