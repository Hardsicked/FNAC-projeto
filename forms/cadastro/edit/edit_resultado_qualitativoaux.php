...
<body>
	<form id="" class="" action="/fnac/forms/cadastro/edit/edit_resultado_qualitativo.php" method="POST">
		<table class="table table-sm table-light">
			...
			<tbody>
				<tr>
					<td>Codígo da GHE</td>
					<td><input type="text" name="cresul" value="<?php echo $resultado;?>" hidden>
						<?php
