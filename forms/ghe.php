...
<script>
	...
	$(".editarghe").click(function(){
		var $value = $(this).attr("ghe");
										...
										while($row3 = mysqli_fetch_assoc($res3)){
											...
											echo '
												<tr style="background-color: ">
													...
													<td><img class="editarghe" src="img/icons/edit.png" width="24px" height="24px" ghe="forms/cadastro/edit/edit_gheaux1.php?c='.$empid.'&ci='.$row['cdContrato'].'&g='.$row["cdGHE"].'" class="icone2"/></td>
