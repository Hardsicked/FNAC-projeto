...
?>
	...
	<body>
		<div class="container-fluid">
			<div class="row">
				<div class="col-3">
					<h2 class="text-center">Fichas Qualitativas</h2>
				</div>
				<div class="col-6"></div>
				<div class="col-3">
					<div class="novobotao text-center novoquali" resultado="forms/cadastro/add_ficha_quali.php?c=<?php echo $contratoid; ?>" style="margin-top: 8px; background-color: #94f441; cursor: pointer; color: white; border-radius: 2px;"><b>Nova Ficha Qualitativa</b></div>
				</div>
			</div>
			<div class="row">
					...
					<table class="table table-sm table-light table-stripped table-bordered">
						...
						<tbody>
							<?php 
								...
								$sql_fichag = "SELECT * FROM tbficha_ghe WHERE cdGHE = ".$ghe." AND tipo = 5";
								$qry_fichag = mysqli_query($link,$sql_fichag);
								while($assoc_fichag = mysqli_fetch_assoc($qry_fichag)){
									$sql_ficha = "SELECT * FROM tbficha_quali WHERE cdFicha = ".$assoc_fichag['cdFicha'];
									$query_ficha = mysqli_query($link,$sql_ficha);
										...
										while($assoc_ficha = mysqli_fetch_assoc($query_ficha)){	
											$sql_agent = "SELECT * FROM tbagente WHERE cdAgente = ".$assoc_ficha["cdAgente"];
											...
											echo '			<td class="text-center">'.$assoc_fichag['DR'].'</td>
														...
														<td class="text-center"><input type="radio" id="fichaquali" name="fichaquali" class="infocd" value="'.$assoc_ficha['cdFicha'].'"></td>
														...
														echo'<td class="text-center">'.$nomeagente.'</td>
